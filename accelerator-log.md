...
```json
{
  ...
  "repositoryPrefix" : "https://harbor.dieunkrauts.de/tap-wkld/tanzu-java-web-app-test01"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->https://harbor.dieun...(truncated)]
